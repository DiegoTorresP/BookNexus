...
namespace BookNexus.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(BookNexusContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,ApellidoPat,ApellidoMat,FechaNac,Genre,Correo,Telefono,NombreUsuario,password")] Usuarios usuarios)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,ApellidoPat,ApellidoMat,FechaNac,Genre,Correo,Telefono,NombreUsuario,password")] Usuarios usuarios)
        {
            if (id != usuarios.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BookNexusContext.Usuarios'  is null.");
            }
            var usuarios = await _context.Usuarios.FindAsync(id);
            if (usuarios != null)
            {
